  ...
  return (
    <div className={classes.contentCV}>
        ...
        <Grid container spacing={3}>
          <Grid item lg={12} md={12} sm={12} xs={12} className={classes.flex} style={{justifyContent: "center"}}>
            <Typography variant="h5" className="mt-20 mb-20"  >
              <b style={{textAlign: "center"}}>ĐƠN XIN NGHỈ VIỆC</b>
            </Typography>
          </Grid>
          ...
          <Grid item lg={12} md={12} sm={12} xs={12} className={classes.flex}>
            <Typography style={{ minWidth: "max-content" }}>
              Tôi làm đơn này đề nghị ban giám đốc cho tôi xin nghỉ việc với lý do:
            </Typography>
            <Grid item lg={12} md={12} sm={12} xs={12}>
              <TextField
                className={classes.inputExps}
        ...
        <Grid container spacing={3}>
          <Grid item lg={12} md={12} sm={12} xs={12}>
            <p className="mt-10">
             Trong quá trình làm việc ở đây, tôi đã học hỏi được rất nhiều điều từ quản lý cũng như đồng nghiệp. Tôi cảm thấy thực sự may mắn khi được làm việc trong môi trường hòa đồng và chuyên nghiệp. Tôi xin chân thành cảm ơn Công ty đã tin tưởng tôi trong suốt thời gian vừa qua và chúc cho Công ty chúng ta sẽ đạt được những thành công như mong muốn.
            </p>
            <p className="mt-10">
