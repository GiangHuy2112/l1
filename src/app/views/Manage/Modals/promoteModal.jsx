    ...
    <div className={classes.contentCV}>
        <Grid container spacing={3}>
          <Grid item lg={12} md={12} sm={12} xs={12} className={classes.headerCV}>
            ...
            <h5 className="mt-10">Về việc tăng chức nhân viên</h5>
          </Grid>
          ...
          <Grid item lg={6} md={6} sm={12} xs={12} className={classes.flex}>
            ...
            <Grid item lg={12} md={12} sm={12} xs={12}>
              <TextField
                ...
                disabled={readOnly}
                type="text"
                value={dataEmployee.position.find(item => item.id === rowData.currentPosition)?.name || ""}
                InputProps={{
                  disableUnderline: true,
                  className: classes.input + " " + classes.disable,
                }}
          ...
          <Grid item lg={6} md={6} sm={12} xs={12} className={classes.flex}>
            ...
            <Grid item lg={12} md={12} sm={12} xs={12}>
              <TextField
                ...
                disabled={readOnly}
                type="text"
                value={dataEmployee.position.find(item => item.id === rowDataModal.newPosition)?.name || ""}
                InputProps={{
                  disableUnderline: true,
                  className: classes.input + " " + classes.disable,
                }}
        ...
        <Grid container spacing={3}>
          <p className="mt-20" style={{ padding: "0 10px" }}>
            Rất mong bộ phận nhân sự, phòng kế toán và phòng quản lí thi hành thực hiện quyết định này trong thời gian sớm nhất!
          </p>
